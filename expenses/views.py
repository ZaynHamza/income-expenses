...
# YOU NEED TO INSTALL (GTK3) AND ADD IT PATH AND ADD THE LINE BELOW BEFORE INTERACTING WITH (WEASYPRINT)
import os
...
def export_pdf(request):
    ...
    # YOU NEED TO INSTALL (GTK3) AND ADD IT PATH BEFORE INTERACTING WITH (WEASYPRINT)
